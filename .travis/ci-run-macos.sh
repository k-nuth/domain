...
python ../ci_utils/run-clang-tidy.py -checks='*,-android-*,-llvm-header-guard,-fuchsia*,-google-runtime-references,-cert-err58-cpp,-cppcoreguidelines-special-member-functions,-modernize-pass-by-value,-cert-dcl21-cpp,-google-explicit-constructor,-hicpp-explicit-conversions,-hicpp-member-init,-hicpp-signed-bitwise,-google-build-using-namespace,-hicpp-special-member-functions,-cppcoreguidelines-pro-type-member-init,-cppcoreguidelines-pro-bounds-pointer-arithmetic,-cppcoreguidelines-pro-bounds-array-to-pointer-decay,-hicpp-no-array-decay,-misc-macro-parentheses,-bugprone-macro-parentheses,-readability-uppercase-literal-suffix,-readability-magic-numbers,-hicpp-uppercase-literal-suffix,-cppcoreguidelines-macro-usage,-cppcoreguidelines-avoid-magic-numbers' -warnings-as-errors='*'  -header-filter=/Users/fernando/dev/kth/kth-domain/include/
