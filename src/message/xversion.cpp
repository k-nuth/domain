...
uint32_t const message::xversion::version_minimum = level::minimum;
uint32_t const message::xversion::version_maximum = level::maximum;
...
xversion::xversion(uint32_t value, uint64_t services, uint64_t timestamp, network_address const& address_receiver, network_address const& address_sender, uint64_t nonce, std::string&& user_agent, uint32_t start_height, bool relay)
...
uint32_t xversion::value() const {
    return value_;
}

void xversion::set_value(uint32_t value) {
    value_ = value;
}

uint64_t xversion::services() const {
    return services_;
}

void xversion::set_services(uint64_t services) {
    services_ = services;
}

uint64_t xversion::timestamp() const {
    return timestamp_;
}

void xversion::set_timestamp(uint64_t timestamp) {
    timestamp_ = timestamp;
}

network_address& xversion::address_receiver() {
    return address_receiver_;
}

network_address const& xversion::address_receiver() const {
    return address_receiver_;
}

void xversion::set_address_receiver(network_address const& address) {
    address_receiver_ = address;
}

network_address& xversion::address_sender() {
    return address_sender_;
}

network_address const& xversion::address_sender() const {
    return address_sender_;
}

void xversion::set_address_sender(network_address const& address) {
    address_sender_ = address;
}

uint64_t xversion::nonce() const {
    return nonce_;
}

void xversion::set_nonce(uint64_t nonce) {
    nonce_ = nonce;
}

std::string& xversion::user_agent() {
    return user_agent_;
}

std::string const& xversion::user_agent() const {
    return user_agent_;
}

void xversion::set_user_agent(std::string const& agent) {
    user_agent_ = agent;
}

void xversion::set_user_agent(std::string&& agent) {
    user_agent_ = std::move(agent);
}

uint32_t xversion::start_height() const {
    return start_height_;
}

void xversion::set_start_height(uint32_t height) {
    start_height_ = height;
}

bool xversion::relay() const {
    return relay_;
}

void xversion::set_relay(bool relay) {
    relay_ = relay;
}
