...
inline chain::transaction const& program::transaction() const {
    return transaction_;
}
...
// Be explicit about the intent to move or copy, to get compiler help.
inline void program::push_copy(value_type const& item) {
...
inline data_stack::value_type const& program::item(size_t index) /*const*/ {
